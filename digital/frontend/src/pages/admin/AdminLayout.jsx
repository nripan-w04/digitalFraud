...
const NavItem = ({ icon, label, to, end, onClick }) => (
    <NavLink
        ...
        onClick={onClick}
        className={({ isActive }) => `flex items-center gap-5 px-6 py-5 rounded-2xl font-bold transition-all no-underline text-sm tracking-[0.2em] uppercase ${isActive ? 'bg-accent/10 text-accent border border-accent/20' : 'text-white/40 hover:bg-white/5 hover:text-white'
            }`}
    >
